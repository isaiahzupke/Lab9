 ...
 * same first character as a designated word. This class uses indexing methods to sort through the list
 * and returns a new list with relevant words.
 */
public class IndexSearch implements AutoCompleter {
     ...
     */
    public IndexSearch(List<String> list, Logger logger){
        this.list = list;
        this.logger = logger;
    }
